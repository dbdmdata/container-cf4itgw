...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cf4itgw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cf4itgw.containers.anotherwebservice.com/
...
```
git clone git@github.com:dbdmdata/container-cf4itgw.git
cd container-cf4itgw
```
...
```
docker attach container-cf4itgw
```
